...
import 'package:photographer_app_1_11/models/album_bloc_model.dart';
import 'package:photographer_app_1_11/models/category_bloc_model.dart';
import 'package:photographer_app_1_11/models/image_bloc_model.dart';
...
class AlbumRepository {
  ...
  Future<List<AlbumBlocModel>> getListAlbum() async {
    final response = await this.httpClient.get(baseUrl + 'albums/', headers: {
