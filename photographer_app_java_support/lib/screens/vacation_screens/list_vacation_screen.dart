...
import 'package:photographer_app_java_support/widgets/shared/list_vation_loading.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: BlocBuilder<BusyDayBloc, BusyDayState>(
