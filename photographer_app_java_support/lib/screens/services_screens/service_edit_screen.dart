...
import 'package:photographer_app_java_support/models/service_model.dart';
import 'package:photographer_app_java_support/widgets/service/mini_service_header.dart';
...
class _EditServiceState extends State<EditService> {
  ...
  _updatePackage() async {
    ...
    BlocProvider.of<PackageBloc>(context)
        .add(PackageEventUpdate(package: packageTemp));
  }
