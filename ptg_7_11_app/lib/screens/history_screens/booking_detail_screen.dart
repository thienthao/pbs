...
import 'package:ptg_7_11_app/models/booking_bloc_model.dart';
import 'package:ptg_7_11_app/models/customer_bloc_model.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'file:///E:/Studies/flutter_study/ptg_7_11_app/lib/screens/history_screens/location_guide.dart';
...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  _cancelBooking(BookingBlocModel _booking, String _cancelReason) async {
    BookingBlocModel bookingTemp = BookingBlocModel(
        ...
        package: _booking.package);
    print('${bookingTemp.customer.id}');
    context.bloc<BookingBloc>().add(BookingEventCancel(booking: bookingTemp));
  }
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () => launch('tel://${bookingState.booking.customer.phone}'),
                                            ),
                                            IconButton(
                                                icon: Icon(
