...
import 'package:ptg_7_11_app/widgets/customshapeclipper.dart';
import 'package:ptg_7_11_app/widgets/history/booking_widget.dart';
import 'package:ptg_7_11_app/widgets/history/drop_menu_history.dart';
...
class _BookHistoryState extends State<BookHistory> {
  ...
  _loadBookingsByPaging(String _status) async {
    context.bloc<BookingBloc>().add(BookingEventFetchInfinite(status: _status));
  }
