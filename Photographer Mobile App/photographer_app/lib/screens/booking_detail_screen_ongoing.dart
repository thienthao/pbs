...
class BookingDetailScreenOngoing extends StatefulWidget {
  @override
  _BookingDetailScreenOngoingState createState() => _BookingDetailScreenOngoingState();
}

class _BookingDetailScreenOngoingState extends State<BookingDetailScreenOngoing> {
  Future<void> _showMyDialog() async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Bạn muốn hủy cuộc hẹn?',
