...
import 'package:cus_2_11_app/blocs/category_blocs/categories.dart';
import 'package:cus_2_11_app/blocs/photographer_alg_blocs/photographers_alg.dart';
import 'package:cus_2_11_app/blocs/photographer_blocs/photographers.dart';
import 'package:cus_2_11_app/screens/home_screens/search_ptg_service.dart';
import 'package:cus_2_11_app/widgets/home_screen/album_bloc_carousel.dart';
import 'package:cus_2_11_app/widgets/home_screen/icon_carousel.dart';
import 'package:cus_2_11_app/widgets/home_screen/photograph_carousel.dart';
import 'package:cus_2_11_app/widgets/home_screen/photograph_carousel_byfactor_alg.dart';
import 'package:cus_2_11_app/widgets/home_screen/sliver_items.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 5), () {
      context
          .bloc<PhotographerAlgBloc>()
          .add(PhotographerAlgEventFetchByFactorAlg());
    });
  }

  _loadAlbums(_categoryId) async {
    context.bloc<AlbumBloc>().add(AlbumEventFetch(categoryId: _categoryId));
  }
            ...
            actions: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => SearchPtgService()),
                  );
                },
              ),
            ],
            flexibleSpace: FlexibleSpaceBar(
              background: SliverItems(onChangeLocation: (Map result) {
