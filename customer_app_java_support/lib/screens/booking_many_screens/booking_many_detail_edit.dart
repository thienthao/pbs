...
class BookingManyDetailEdit extends StatefulWidget {
  ...
  const BookingManyDetailEdit(
      {this.model, this.onUpdateList, this.ptgId, this.timeAnticipate});
  @override
...
class _BookingManyDetailEditState extends State<BookingManyDetailEdit> {
  ...
  Widget _buildNoticeHourly(Map time) {
    var widget = <Widget>[];
                        ...
                        Container(
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: _buildNoticeHourly(notice.time),
                              ),
