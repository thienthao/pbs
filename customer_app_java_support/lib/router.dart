...
BookingRepository _bookingRepository = BookingRepository(httpClient: http.Client());
  ...
  switch(settings.name) {
    ...
    case BookingDetail:
      ...
      return MaterialPageRoute(builder: (context) => BlocProvider(
        create: (context) => BookingBloc(bookingRepository: _bookingRepository)..add(BookingEventDetailFetch(id: bookingId)),
        child: BookingWidget(),
        //child: BookingDetailScreen(bookingId: bookingId),
      ));
    case BookingHistory:
      return MaterialPageRoute(builder: (context) => BlocProvider(
        create: (context) => BookingBloc(bookingRepository: _bookingRepository)..add(BookingEventFetch()),
        child: BookHistory(),
      ));
    default:
